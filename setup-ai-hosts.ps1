...
Write-Progress -Id $Global:ProgressIdInner -ParentId $Global:ProgressIdOuter -Activity $PA -Status "Downloading AI Hosts Block Script..." -PercentComplete 10
...
Write-Progress -Id $Global:ProgressIdInner -ParentId $Global:ProgressIdOuter -Activity $PA -Status "Applying Blocklist..." -PercentComplete 50
